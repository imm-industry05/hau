...
<!----Testimonial---->
    <div class ="testimonial">
        <div class="small-container">
            <div class="row">
                <div class="col-3">
                    ...
                    <p>They Think We're Ugly But I Know We're Beautiful And We Can Adapt To A Hostile Environment.</p>
                    <div class="rating">
                        <i class="fa fa-star"></i>
                        <i class="fa fa-star"></i>
                        <i class="fa fa-star"></i>
            ...
            <div class="col-3">
                <i class="fa fa-quote-left"></i>
                <p>At some point you have to make a decision. Boundaries don't keep other people out, they fence you in. Life is messy. That's how we're made. So you can waste your life drawing lines... or you can live your life crossing them.</p>
                <div class="rating">
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
        ...
        <div class="col-3">
            <i class="fa fa-quote-left"></i>
            <p>There comes a time when the desire to rest overcomes the desire to live.</p>
            <div class="rating">
                <i class="fa fa-star"></i>
                <i class="fa fa-star"></i>
                <i class="fa fa-star"></i>
