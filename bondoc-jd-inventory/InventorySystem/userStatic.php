...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="http://localhost/InventorySystem/css/userStatic.css" />
    <link
  ...
  <body>
    <main>
      <section class="landing">
        ...
        <p class="big-text3"><a href="http://localhost/InventorySystem/userStaticPage.php">Here <i class="fa-solid fa-forward"></i></a></p>
      </section>
    </main>
    <div class="intro">
    ...
    <script src="http://localhost/InventorySystem/app.js"></script>
  </body>
</html>