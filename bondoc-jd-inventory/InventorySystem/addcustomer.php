...
<body>
<ul>
<li><a class="active" href="/InventorySystem/adminPage.php">Dashboard<i class="fa fa-home"></i></a></li>
...
<br/><br/>
    ...
    <div class="empContainer">
        <div class="inputEmployee">
         <div class="emp">
                <form action="/InventorySystem/forms/insertCustomer.php" method="POST">
                    <div class="inputEmp">
