...
<body>
    <div class="topnav">
        <ul>
            ...
            <li><a class="active" href="/InventorySystem/insidephp/supplier.php">Supplier <i class="fa-solid fa-handshake"></i></a></li>
    ...
    <div class="addbtn">
            <form action="/InventorySystem/addsupplier.php">
