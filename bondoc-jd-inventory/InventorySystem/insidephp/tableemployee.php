...
<body>
    <div class="topnav">
        <ul>
            ...
            <li><a class="active" href="http://localhost/InventorySystem/insidephp/tableemployee.php">Employee <i class="fa-solid fa-user-tie"></i></a></li>
    ...
    <div class="addbtn">
            <form action="http://localhost/InventorySystem/employee.php">
