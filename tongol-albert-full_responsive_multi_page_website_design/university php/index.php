...
<body>
    <section class="header">
        ...
        <div class="text-box">
            <h1>The First Lay-founded and <br>Co-educational Catholic School</h1>
            <p>Private research non-profit coeducational Basic and <br>Higher education institution</p>
            <a href="https://www.hau.edu.ph/" target="_blank" class="hero-btn"> Visit Us To Know More</a>
        </div>
...
<section class="campus">
    <h1>Our Angelite Campus</h1>

    <div class="row">
        <div class="campus-col">
            <img src="images/ggn.png">
            <div class="layer">
                <h3>Geromin G. Nepomuceno Building</h3>
            </div>
        </div>
        <div class="campus-col">
            <img src="images/sjh.jpg">
            <div class="layer">
                <h3>Saint Joseph Hall</h3>
            </div>
        </div>
        <div class="campus-col">
            <img src="images/sfj.jpg">
            <div class="layer">
                <h3>San Francisco Javier Building</h3>
            </div>
        </div>
    </div>
</section>
...
<!-----------------testimonials------------------>
    ...
    <section class="testimonials">
        <h1>What Our Formal Students Says</h1>
    <div class="row">
        <div class="testimonials-col">
            <img src="images/user1.jpg">
            <div>
                <p>Holy Angel University is, if not the best, one of the best schools in the region teaching accountancy. The atmosphere is highly suitable to learning. Professors (specifically) in the Accountancy Department also practice their profession and share real-life situations which makes every class interesting.</p>
                <h3>Nicole Mercado</h3>
        ...
        <div class="testimonials-col">
            ...
            <div>
                <p>I have chosen this particular school because of it's quality education. The University prepares it's students in every aspect of their lives, giving them the best ambiance and education possible. It also gives it's students a sense of comfort, no one will ever feel out of place.</p>
                <h3>Patrick Santos</h3>
                <i class="fa fa-star"></i>
                <i class="fa fa-star"></i>
                <i class="fa fa-star"></i>
                <i class="fa fa-star"></i>
...
<section class="cta">
    <h1>Enroll For Various Online Courses <br> Anywhere From Around the World</h1>
