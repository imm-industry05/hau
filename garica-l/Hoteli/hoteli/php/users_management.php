  ...
  <head>
        ...
        <style>
           *{
            ...
            #background{
                background-image: url('assets/dashboardbg.jpg');
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="container_info">
                                    ...
                                    <a href="users_management_add.php">
                                        <button class="btn btn-success">+ ADD</button>
                                    </a>
                                            <tr>
                                                <th id="name">Name</th>
                                                <th id="emails">Email</th>
                                                <th id="password">Password</th>
                                                <th id="usertype">Role Type</th>
                                                <th colspan="2" id="actions">Action</th>
                                            </tr>
                                        ...
                                        <?php
                                            while ($row = $result->fetch_assoc()): ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="users_management_edit.php?edit=<?php echo $row['id']; ?>"><button type="button" class="btn btn-primary">Edit</button></a>
                                                
                                                        <a href="process.php?deleteuser=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure you want to delete this account?');"><button type="button" class="btn btn-danger">Delete</button></a>
                                                    </td>
                                                </tr>
                                        <?php 
                                            endwhile; 
