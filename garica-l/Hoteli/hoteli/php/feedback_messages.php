        ...
        <div class="sidebar close">
            ...
            <ul class="nav-links">
                ...
                <li>
                    ...
                    <ul class="sub-menu blank">
                        <li><a class="link_name" href="#">Feedback Messages</a></li>
                    </ul>
                </li>
                <li>
                ...
                <div class="container">
                    <div class="row">
                        <div class="container_info">
                            ...
                            <table class="center col-md-19">
                                    <tr>
                                        <th id="names">Name</th>
                                        <th id="emails">Email</th>
                                        <th id="feedbacks">Feedback</th>
                                        <th id="suggestions">Suggestion</th>
                                ...
                                <?php
                                    while ($row = $result->fetch_assoc()): ?>
                                        <tr>
                                            ...
                                            <td id="fb"><?php echo $row['fb']; ?></td>
                                            <td id="suggestion"><?php echo $row['suggestion']; ?></td>
                                            <td>
                                                <a href="process.php?deletefeedback=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure you want to delete this account?');">
                                                <button type="button" class="btn btn-danger" id="delete">Delete</button></a>
                                            </td>
                                        </tr>
                                <?php 
                                    endwhile; 
